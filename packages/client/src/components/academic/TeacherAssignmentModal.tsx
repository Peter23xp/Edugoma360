...
export default function TeacherAssignmentModal({
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-[#0F1E12]/45 backdrop-blur-sm">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl border border-neutral-200 flex flex-col max-h-[90vh] overflow-hidden">
                {/* Header */}
                                ...
                                >
                                    ...
                                    <div>
                                        <select
                                            ...
                                            className="w-full px-3 py-2 bg-neutral-50 border border-neutral-200 rounded-lg text-sm text-neutral-900 focus:bg-white focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/10 transition-all"
                                        >
                ...
                <div className="px-6 py-4 border-t border-neutral-200 flex gap-3">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-6 py-2 bg-primary text-white
                                   rounded-lg hover:bg-primary-hover font-medium text-sm
