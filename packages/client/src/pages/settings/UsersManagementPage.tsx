    ...
    <div className="w-full max-w-full overflow-hidden space-y-4 lg:space-y-6 pb-24">
      ...
      <div className="bg-background/95 backdrop-blur border-b border-neutral-200 shadow-sm py-4 mb-6 -mx-3 px-3 sm:-mx-4 sm:px-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 text-sm font-medium bg-primary hover:bg-primary-hover text-white rounded-lg transition-all duration-200 w-full sm:w-auto"
        >
          <Plus size={15} />
          Créer utilisateur
        </button>
