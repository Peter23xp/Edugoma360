...
async function main() {
    ...
    const teachersData = [
        { nom: 'PALUKU', postNom: 'KAMBASU', prenom: 'Emmanuel', phone: '+243990000005', diplome: 'Licence en Mathématiques', statut: 'MECHANISE' },
        { nom: 'MASIKA', postNom: 'SIVIHWA', prenom: 'Aline', phone: '+243990000006', diplome: 'Licence en Lettres Françaises', statut: 'MECHANISE' },
        { nom: 'KASEREKA', postNom: 'LUSENGE', prenom: 'Benjamin', phone: '+243990000007', diplome: 'Licence en Physique', statut: 'NON_PAYE' },
        { nom: 'KAHAMBU', postNom: 'NDUNGO', prenom: 'Jeanne', phone: '+243990000009', diplome: 'Graduat en Biologie', statut: 'NOUVELLE_UNITE' },
        { nom: 'MBUSA', postNom: 'KITSALI', prenom: 'Robert', phone: '+243990000010', diplome: 'Licence en Sciences Économiques', statut: 'VACATAIRE' },
    ];
    const teachers = [];
    ...
    const studentsData = [
        // 1ère A
        { nom: 'BAHATI', postNom: 'IRAGI', prenom: 'David', sexe: 'M', dob: '2010-03-15', lieu: 'Goma', classIdx: 0 },
        { nom: 'FURAHA', postNom: 'KYALONDAWA', prenom: 'Sarah', sexe: 'F', dob: '2010-07-22', lieu: 'Goma', classIdx: 0 },
        { nom: 'ISHARA', postNom: 'MUGABO', prenom: 'Josué', sexe: 'M', dob: '2010-01-10', lieu: 'Sake', classIdx: 0 },
        { nom: 'KABUO', postNom: 'MWEZE', prenom: 'Amani', sexe: 'M', dob: '2010-11-05', lieu: 'Goma', classIdx: 0 },
        { nom: 'KAVIRA', postNom: 'MAOMBI', prenom: 'Esther', sexe: 'F', dob: '2010-05-30', lieu: 'Butembo', classIdx: 0 },
        { nom: 'MUGISHA', postNom: 'BARAKA', prenom: 'Samuel', sexe: 'M', dob: '2010-09-12', lieu: 'Goma', classIdx: 0 },
        { nom: 'NEEMA', postNom: 'KAHINDO', prenom: 'Joy', sexe: 'F', dob: '2010-02-28', lieu: 'Beni', classIdx: 0 },
        { nom: 'RIZIKI', postNom: 'HABIMANA', prenom: 'Noé', sexe: 'M', dob: '2010-08-18', lieu: 'Goma', classIdx: 0 },
        { nom: 'SIFA', postNom: 'NYOTA', prenom: 'Grâce', sexe: 'F', dob: '2010-12-01', lieu: 'Rutshuru', classIdx: 0 },
        { nom: 'TUMAINI', postNom: 'KAMBALE', prenom: 'Élie', sexe: 'M', dob: '2010-04-20', lieu: 'Goma', classIdx: 0 },
        // 3ème SCIENT A
        { nom: 'AMANI', postNom: 'PALUKU', prenom: 'Christian', sexe: 'M', dob: '2008-06-14', lieu: 'Goma', classIdx: 3 },
        { nom: 'BARAKA', postNom: 'KAMBALE', prenom: 'Gloire', sexe: 'M', dob: '2008-03-08', lieu: 'Butembo', classIdx: 3 },
        { nom: 'FAIDA', postNom: 'MUHINDO', prenom: 'Rachel', sexe: 'F', dob: '2008-10-25', lieu: 'Goma', classIdx: 3 },
        { nom: 'KAHINDO', postNom: 'KATUNGU', prenom: 'Espérance', sexe: 'F', dob: '2008-01-17', lieu: 'Beni', classIdx: 3 },
        { nom: 'LUKA', postNom: 'MUSAVULI', prenom: 'Daniel', sexe: 'M', dob: '2008-07-30', lieu: 'Goma', classIdx: 3 },
        { nom: 'MAPENDO', postNom: 'SIVIHWA', prenom: 'Josiane', sexe: 'F', dob: '2008-04-12', lieu: 'Sake', classIdx: 3 },
        { nom: 'NDUNGO', postNom: 'KASEREKA', prenom: 'Moïse', sexe: 'M', dob: '2008-09-03', lieu: 'Goma', classIdx: 3 },
        { nom: 'ZAWADI', postNom: 'MASIKA', prenom: 'Déborah', sexe: 'F', dob: '2008-12-19', lieu: 'Lubero', classIdx: 3 },
        // 3ème COMM A
        { nom: 'BYAMUNGU', postNom: 'IRENGE', prenom: 'Patrick', sexe: 'M', dob: '2008-02-14', lieu: 'Goma', classIdx: 4 },
        { nom: 'FIKIRI', postNom: 'BAHATI', prenom: 'Rebecca', sexe: 'F', dob: '2008-08-07', lieu: 'Minova', classIdx: 4 },
        { nom: 'KABUO', postNom: 'NGABO', prenom: 'Jonathan', sexe: 'M', dob: '2008-05-21', lieu: 'Goma', classIdx: 4 },
        { nom: 'MASIKA', postNom: 'FURAHA', prenom: 'Esther', sexe: 'F', dob: '2008-11-13', lieu: 'Beni', classIdx: 4 },
        { nom: 'MUHINDO', postNom: 'KYABU', prenom: 'Abel', sexe: 'M', dob: '2008-06-28', lieu: 'Goma', classIdx: 4 },
        // 4ème SCIENT A
        { nom: 'CIZA', postNom: 'KABUYA', prenom: 'Pacifique', sexe: 'M', dob: '2007-03-22', lieu: 'Goma', classIdx: 5 },
        { nom: 'DUSABE', postNom: 'MUGABO', prenom: 'Victoire', sexe: 'F', dob: '2007-07-14', lieu: 'Sake', classIdx: 5 },
        { nom: 'MUKIZA', postNom: 'PALUKU', prenom: 'Isaac', sexe: 'M', dob: '2007-01-09', lieu: 'Goma', classIdx: 5 },
        // 4ème PEDAG A
        { nom: 'KAMBALE', postNom: 'KAGHENI', prenom: 'Rosette', sexe: 'F', dob: '2007-09-18', lieu: 'Butembo', classIdx: 6 },
        { nom: 'IRAGI', postNom: 'BALUME', prenom: 'Moïse', sexe: 'M', dob: '2007-05-02', lieu: 'Goma', classIdx: 6 },
        { nom: 'KAHAMBU', postNom: 'KATEMBO', prenom: 'Léa', sexe: 'F', dob: '2007-11-25', lieu: 'Lubero', classIdx: 6 },
        { nom: 'MUHINDO', postNom: 'TSONGO', prenom: 'Jonas', sexe: 'M', dob: '2007-04-17', lieu: 'Goma', classIdx: 6 },
    ];
    ...
    if (economeUser) {
        const paymentModes = ['ESPECES', 'AIRTEL_MONEY', 'MPESA', 'ORANGE_MONEY'];
        let paySeq = 1;
        for (let i = 0; i < 8; i++) {
    ...
    for (const u of users) {
        const loginId = u.email ? `${u.email} / ${u.phone}` : u.phone;
