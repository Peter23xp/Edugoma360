...
import { upload as diskUpload } from '../../lib/storage';
...
router.post('/', requirePermission('students:create'), diskUpload.single('photo'), (req, res, next) => studentsController.createStudent(req, res, next));
router.put('/:id', requirePermission('students:update'), diskUpload.single('photo'), (req, res, next) => studentsController.updateStudent(req, res, next));
...
router.get('/:id/certificate', requirePermission('students:read'), (req, res, next) => studentsController.generateAttestation(req, res, next));
